...
function sendEscalationEmail(target: string, events: AlertEvent[], org: string, rule: EscalationRule) {
  console.log(`[ESCALATION] Email to ${target} for org ${org}:`, events.map(e => e.message))
}
