        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Track new driver onboarding progress and completion
            </p>
          </div>
        </div>
                ...
                {filteredOnboarding.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-400">
                      Add a new driver to start the onboarding process
                    </p>
                  </div>
                ) : (
                      ...
                      <div className="flex justify-between items-start mb-3">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <Badge
                              className={getStatusColor(item.onboarding_status)}
                            >
                      ...
                      <div className="mb-3">
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-sm font-medium">
                            Progress: {item.completed_steps} of{" "}
                            {item.total_steps} steps
                          </span>
                          <span
                            className={`text-sm font-bold ${getProgressColor(item.completion_percentage)}`}
                          >
                          ...
                          item.actual_completion_date ? (
                            ...
                            <span
                              className={`flex items-center gap-1 ${
                                getDaysRemaining(item.target_completion_date) <
                                0
                                  ? "text-red-600"
                                  : getDaysRemaining(
