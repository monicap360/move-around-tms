    ...
    items: [
      {
        title: "Engine Oil",
        description:
          "Check oil level and condition for proper engine lubrication",
        checkPoints: [
...
export default function DVIRReferencePage() {
  ...
  const currentSection = DVIR_REFERENCES.find(
    (section) => section.id === selectedSection,
  );

  const filteredSections = DVIR_REFERENCES.filter(
    (section) =>
      searchQuery === "" ||
            ...
            <div>
              ...
              <ul className="space-y-2">
                {selectedItem.checkPoints.map((point, index) => (
                  <li
                    key={index}
                    className="flex items-start gap-3 p-3 bg-green-50 rounded"
                  >
            ...
            <div>
              ...
              <ul className="space-y-2">
                {selectedItem.commonDefects.map((defect, index) => (
                  <li
                    key={index}
                    className="flex items-start gap-3 p-3 bg-red-50 rounded"
                  >
            ...
            <div>
              ...
              <ul className="space-y-2">
                {selectedItem.safetyNotes.map((note, index) => (
                  <li
                    key={index}
                    className="flex items-start gap-3 p-3 bg-orange-50 rounded"
                  >
