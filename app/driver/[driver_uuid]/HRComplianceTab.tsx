    ...
    <div className="p-6 max-w-2xl mx-auto">
      ...
      <section className="mb-6">
        ...
        <ul className="space-y-1">
          ...
          <li>
            <b>Employee/Contractor ID:</b> {driver.employee_id || "-"}
          </li>
          <li>
            <b>Status:</b> {driver.status || "-"}
          </li>
          <li>
            <b>Hire Date:</b> {driver.hire_date || "-"} /{" "}
            <b>Termination Date:</b> {driver.termination_date || "-"}
          </li>
          <li>
            <b>Position/Role:</b> {driver.role || "-"}
          </li>
          <li>
            <b>License Number & Class:</b> {driver.license_number || "-"} /{" "}
            {driver.license_class || "-"}
          </li>
          <li>
            <b>License Expiration Date:</b> {driver.license_expiration || "-"}
          </li>
          <li>
            <b>State of Issuance:</b> {driver.license_state || "-"}
          </li>
          <li>
            <b>Endorsements/Restrictions:</b> {driver.endorsements || "-"}
          </li>
          <li>
            <b>Contact Info:</b> {driver.phone || "-"} / {driver.email || "-"}
          </li>
        </ul>
      </section>
