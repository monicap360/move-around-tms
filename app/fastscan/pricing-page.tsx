  ...
  return (
    <main className="max-w-2xl mx-auto py-12 px-4">
      ...
      <p className="text-lg mb-8">
        Fast Scan™ is a premium add-on module for MoveAround TMS, designed to replace costly manual ticket entry and eliminate payroll errors for trucking, aggregates, and construction fleets.
      </p>
      <div className="bg-white rounded-lg shadow p-6 mb-8 border border-gray-200">
        ...
        <div className="mb-2">
          <span className="font-bold">One-Time Setup Fee:</span> <span className="text-xl">$3,500</span>
        </div>
        <div className="mb-2">
          <span className="font-bold">Monthly Subscription:</span> <span className="text-xl">$1,500</span>
        </div>
        <div className="mb-2 text-gray-600 text-sm">
          Includes CSV mapping, ticket format setup, driver/customer matching, payroll logic configuration, onboarding, and go-live validation.
        </div>
      </div>
      <div className="bg-gray-50 rounded-lg shadow p-6 mb-8 border border-gray-100">
        ...
        <ol className="list-decimal pl-6 mb-4 text-base">
          ...
          <li>Fast Scan automatically reviews and flags payroll mistakes, violations, and profit leaks</li>
          <li>Instant weekly driver grouping and payroll readiness</li>
          <li>Audit-ready reports and compliance checks</li>
        </ol>
        <p className="text-base mb-2">We’ll run the first week with you to validate results.</p>
      </div>
      <div className="mb-8">
      ...
      <div className="text-center mb-8">
        <Link href="/demo/fastscan" className="inline-block bg-blue-600 text-white px-6 py-3 rounded font-semibold hover:bg-blue-700 transition">View Demo</Link>
      </div>
