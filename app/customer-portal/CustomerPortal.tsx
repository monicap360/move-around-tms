  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="flex gap-4 mb-6">
        <button
          className={tab === "loads" ? "font-bold underline" : ""}
          onClick={() => setTab("loads")}
        >
          My Loads
        </button>
        <button
          className={tab === "invoices" ? "font-bold underline" : ""}
          onClick={() => setTab("invoices")}
        >
          Invoices
        </button>
        <button
          className={tab === "documents" ? "font-bold underline" : ""}
          onClick={() => setTab("documents")}
        >
          Documents
        </button>
        <button
          className={tab === "book" ? "font-bold underline" : ""}
          onClick={() => setTab("book")}
        >
          Book New Load
        </button>
