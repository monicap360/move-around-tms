...
$$;`,
    ...
    try {
      ...
      optimizationResults.push({
        ...
        message: error
          ? `Error: ${error.message}`
          : "✅ Company assets view created",
        details:
          error ||
          "View public.company_assets_objects is ready for fast queries",
        sql: viewSQL,
      });
    } catch (err) {
      optimizationResults.push({
...
from storage.objects where bucket_id = 'company_assets';`,
    ...
    try {
      ...
      optimizationResults.push({
        ...
        message: viewError
          ...
          : `✅ View working - found ${viewData?.length || 0} assets`,
    ...
    try {
      ...
      const improvement =
        oldDuration > 0
          ? Math.round(((oldDuration - newDuration) / oldDuration) * 100)
          : 0;
      ...
      optimizationResults.push({
        ...
        details: {
          old_method: {
            ...
            file_count: oldData?.length || 0,
          },
          new_method: {
            duration_ms: newDuration,
            file_count: newData?.length || 0,
          },
    ...
    try {
      ...
      optimizationResults.push({
        ...
        message: indexError
          ? "⚠️ Could not check indexes"
          : `✅ Found ${indexData?.length || 0} existing indexes`,
      ...
      optimizationResults.push({
        ...
        details:
          "Supabase maintains internal indexes for bucket_id, name, and path operations",
      });
    }
        ...
        <div className="space-y-4">
          ...
          <Card className="border-green-200 bg-green-50 mt-6">
            ...
            <CardContent className="text-sm text-green-700">
              <p className="mb-3">
                After optimization, update your API routes to use the new view:
              </p>
