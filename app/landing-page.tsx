    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 20, maxWidth: 700, margin: "auto" }}>
          The only Texas-built TMS that automates ticket entry, reconciliation,
          payroll, and dispatch — replacing your $4k–$6k/mo ticket clerk.
        </p>
        <div>
          <a
            href="#"
      ...
      <section style={{ padding: "80px 40px", maxWidth: 1100, margin: "auto" }}>
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontSize: 18 }}>
              Most trucking companies pay <b>$3,500–$5,500 every month</b> for
              someone to manually type tickets, fix Excel sheets, fight CSV
              mismatches, and calculate payroll.
            </p>
      ...
      <section style={{ padding: "80px 40px", maxWidth: 1100, margin: "auto" }}>
        <h2 style={{ textAlign: "center", marginBottom: 40 }}>
          Everything Your Office Does — Automated
        </h2>
        <div
          style={{
            display: "grid",
