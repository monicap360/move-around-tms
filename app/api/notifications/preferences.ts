...
import { getPreferences, setPreferences } from '@/src/notifications/preferences.store'
...
export async function GET(req: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: err.message ?? 'Failed to load preferences' }, { status: 400 })
  }
}
