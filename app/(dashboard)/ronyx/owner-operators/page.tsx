      ...
      <div style={{ maxWidth: 1100 }}>
        ...
        <div style={{ marginBottom: 22 }}>
          ...
          <div style={{ display:"flex", gap:8, flexWrap:"wrap", marginTop:10 }}>
            ...
            <a href="/ronyx/fleet-trucks" style={{ display:"inline-flex", alignItems:"center", gap:7, background:"#0891b2", color:"#fff", textDecoration:"none", padding:"8px 14px", borderRadius:9, fontWeight:800, fontSize:"0.82rem" }}>🚛 Trucks by owner operator →</a>
                  ...
                  {selected.drivers.length === 0 ? (
                    ...
                    const docActionBtns = (doc: OODoc | undefined, key: string) => doc ? (
                      <div style={{ display:"inline-flex", borderRadius:6, border:"1px solid #e2e8f0", overflow:"hidden" }}>
                        <button onClick={() => doc.file_url ? openDoc(doc.file_url, false, doc.file_name, selected.id, doc.type) : flash("No file stored — re-upload to view.")} title={doc.file_url ? "View" : "No file"} style={{ padding:"2px 7px", background:doc.file_url?"#dbeafe":"#f1f5f9", color:doc.file_url?"#1e40af":"#94a3b8", border:"none", fontSize:"0.65rem", fontWeight:700, cursor:"pointer" }}>👁</button>
