...
const SECTIONS = [
  ...
  { id: "custom-fields",label: "Custom Fields",                   icon: "🧩", color: "#0891b2", href: "/ronyx/settings/custom-fields",         desc: "Add custom fields to jobs, tickets, drivers, trucks, customers, and more — without code." },
  { id: "integrations", label: "Integration Hub",                  icon: "🔌", color: "#16a34a", href: "/ronyx/settings/integrations",          desc: "Connectors, webhooks, API keys, and CSV import mapping profiles for third-party systems." },
