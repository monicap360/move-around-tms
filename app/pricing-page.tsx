  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 18 }}>
          MoveAround TMS replaces your $4,000–$6,000/month ticket clerk — for a
      ...
      >
        ...
        <div style={tierStyle}>
          ...
          <p>
            <strong>$1,999 / month</strong>
          </p>
          <p>
            Setup Fee: <strong>$6,999</strong>
          </p>
          <ul>
      ...
      <div style={{ padding: "80px 20px", maxWidth: 1200, margin: "auto" }}>
        <div style={calculatorBoxStyle}>
          ...
          <div style={savingsResultStyle}>
            {weekly ? (
              <span>
                You currently spend <strong>${Math.round(monthly)}/mo</strong>
                <br />
                on manual ticket entry.
                <br />
                <br />
                With MoveAround TMS, you save between{" "}
                <strong>
                  ${minSavings}–${maxSavings} per month
                </strong>
                .
              </span>
            ) : (
