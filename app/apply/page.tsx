...
export default function DriverApplyPage() {
  ...
  return (
    <main className="max-w-lg mx-auto py-10 px-4">
      <h1 className="text-3xl font-bold mb-6 text-blue-700">Apply to Drive with MoveAround</h1>
      {step === 1 && (
      ...
      {step === 2 && success && (
        <div className="bg-green-50 border border-green-200 p-6 rounded shadow text-center">
          ...
          <p>Your application has been received. We’ll review your info and contact you if you’re a match for our customers.</p>
        </div>
      )}
    </main>
  );
