        ...
        <CardContent className="space-y-4 mt-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <div>
              ...
              <select
                className="w-full px-3 py-2 border rounded"
                value={form.role_type as any}
                onChange={(e) =>
                  setForm({ ...form, role_type: e.target.value as any })
                }
              >
            ...
            <div>
              ...
              <select
                className="w-full px-3 py-2 border rounded"
                value={form.worker_type as any}
                onChange={(e) =>
                  setForm({ ...form, worker_type: e.target.value as any })
                }
              >
                <option>W2</option>
                <option>1099</option>
            ...
            <div>
              ...
              <select
                className="w-full px-3 py-2 border rounded"
                value={form.pay_type as any}
                onChange={(e) =>
                  setForm({ ...form, pay_type: e.target.value as any })
                }
              >
                      ...
                      <td className="p-2">
                        <div className="flex items-center gap-2">
                          <input
                            ...
                            defaultValue={it.hourly_rate ?? ""}
                            onBlur={(e) =>
                              updateEmployee(it.id, {
                                hourly_rate: e.target.value
                                  ? parseFloat(e.target.value)
                                  : null,
                              })
                          ...
                          <input
                            ...
                            defaultValue={it.percentage_rate ?? ""}
                            onBlur={(e) =>
                              updateEmployee(it.id, {
                                percentage_rate: e.target.value
                                  ? parseFloat(e.target.value)
