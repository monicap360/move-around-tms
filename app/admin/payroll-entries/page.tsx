          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, pay_period_start: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({ ...form, pay_period_end: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <select
                className="w-full px-3 py-2 border rounded"
                value={(form.pay_type as any) || "hourly"}
                onChange={(e) =>
              ...
              <>
                <div>
                  ...
                  <input
                    ...
                    step="0.01"
                    className="w-full px-3 py-2 border rounded"
                    value={form.load_revenue ?? ""}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        load_revenue: e.target.value
                          ? parseFloat(e.target.value)
                          : null,
                      })
                    }
              ...
              <tbody>
                {items.map((it) => (
                  <tr key={it.id} className="border-b hover:bg-gray-50">
                    ...
                    <td className="p-2">
                      {it.pay_period_start} → {it.pay_period_end}
                    </td>
