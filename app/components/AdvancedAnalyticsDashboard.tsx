            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {metrics.activeDrivers.current}
                  </p>
                  <div className="flex items-center gap-1 mt-1">
                    {getTrendIcon(metrics.activeDrivers.trend)}
                    <span className="text-sm text-gray-600">
                      {metrics.activeDrivers.current -
                        metrics.activeDrivers.previous}{" "}
                      this period
                    </span>
                  </div>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {metrics.activeVehicles.current}
                  </p>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-32 bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${(metrics.compliance.compliant / metrics.compliance.total) * 100}%`,
                        }}
                      ></div>
                    </div>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-32 bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${(metrics.compliance.expiringSoon / metrics.compliance.total) * 100}%`,
                        }}
                      ></div>
                    </div>
                    <span className="text-sm font-medium">
                      {metrics.compliance.expiringSoon}
                    </span>
                  </div>
                </div>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="w-32 bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${(metrics.compliance.expired / metrics.compliance.total) * 100}%`,
                        }}
                      ></div>
                    </div>
                    <span className="text-sm font-medium">
                      {metrics.compliance.expired}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Badge
                    variant={
                      metrics.safety.incidents === 0 ? "default" : "destructive"
                    }
                  >
