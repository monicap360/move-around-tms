...
export default function DriverProfilePage() {
  ...
  async function loadDriverProfile() {
    try {
      ...
      const driverProfile = {
        ...driverData,
        endorsements: driverData.endorsements ? JSON.parse(driverData.endorsements) : []
      };
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className={`text-2xl font-bold ${getSafetyScoreColor(driver.safety_score)}`}>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {driver.total_miles ? `${(driver.total_miles / 1000).toFixed(0)}k` : '0'}
                </p>
              </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm">{driver.date_of_birth ? new Date(driver.date_of_birth).toLocaleDateString() : 'Not provided'}</p>
                  </div>
                  <div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm">{driver.emergency_contact_relationship || 'Not provided'}</p>
                </div>
              </CardContent>
            </Card>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  <label className="text-sm font-medium text-gray-500">Issuing State</label>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-sm">{new Date(driver.cdl_expiration).toLocaleDateString()}</p>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-sm">{new Date(driver.hire_date).toLocaleDateString()}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Years Experience</label>
                  <p className="text-sm">{driver.years_experience || 'Not provided'} years</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm">{driver.department || 'Not provided'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Supervisor</label>
                  <p className="text-sm">{driver.supervisor || 'Not provided'}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Pay Rate</label>
                  <p className="text-sm">
                    {driver.pay_rate ? `$${driver.pay_rate}${driver.pay_type === 'hourly' ? '/hour' : driver.pay_type === 'mileage' ? '/mile' : ''}` : 'Not provided'}
                  </p>
                </div>
              </div>
              {driver.notes && (
                <div className="mt-6">
                  ...
                  <p className="text-sm bg-gray-50 p-3 rounded-md mt-1">{driver.notes}</p>
                </div>
              )}
            </CardContent>
          </Card>
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                    <div>
                      <label className="text-sm font-medium text-gray-500">Expiration Date</label>
                      <div className="flex items-center gap-2">
                        <p className="text-sm">{driver.medical_cert_expiration ? new Date(driver.medical_cert_expiration).toLocaleDateString() : 'Not provided'}</p>
                        {driver.medical_cert_expiration && isExpiringSoon(driver.medical_cert_expiration) && (
                          <Badge variant="destructive" className="text-xs">Expiring Soon</Badge>
                        )}
                      </div>
                    </div>
                    <div>
                      ...
                      <p className="text-sm">{driver.medical_examiner || 'Not provided'}</p>
                    </div>
                  </div>
                  {driver.medical_restrictions && (
                    <div className="mt-2">
                      <label className="text-sm font-medium text-gray-500">Restrictions</label>
                      <p className="text-sm text-orange-600">{driver.medical_restrictions}</p>
                    </div>
                  )}
                </div>
                ...
                <div className="border-l-4 border-orange-500 pl-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant={driver.hazmat_cert ? "default" : "secondary"}>
                  ...
                  {driver.hazmat_cert && driver.hazmat_expiration && (
                    <div className="mt-2">
                      <label className="text-sm font-medium text-gray-500">Expiration Date</label>
                      <div className="flex items-center gap-2">
                        <p className="text-sm">{new Date(driver.hazmat_expiration).toLocaleDateString()}</p>
                ...
                <div className="border-l-4 border-green-500 pl-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant={driver.defensive_driving_cert ? "default" : "secondary"}>
                      {driver.defensive_driving_cert ? "Certified" : "Not Certified"}
                    </Badge>
                  </div>
                  {driver.defensive_driving_cert && driver.defensive_driving_expiration && (
                    <div className="mt-2">
                      <label className="text-sm font-medium text-gray-500">Expiration Date</label>
                      <div className="flex items-center gap-2">
                        <p className="text-sm">{new Date(driver.defensive_driving_expiration).toLocaleDateString()}</p>
                        {isExpiringSoon(driver.defensive_driving_expiration) && (
                          <Badge variant="destructive" className="text-xs">Expiring Soon</Badge>
                        )}
                      </div>
                    </div>
        ...
        <TabsContent value="performance" className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <label className="text-sm font-medium text-gray-500">Safety Score</label>
                  <p className={`text-2xl font-bold ${getSafetyScoreColor(driver.safety_score)}`}>
                ...
                <div>
                  <label className="text-sm font-medium text-gray-500">Total Miles Driven</label>
                  <p className="text-lg font-semibold">
                    {driver.total_miles ? driver.total_miles.toLocaleString() : 'N/A'} miles
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  <label className="text-sm font-medium text-gray-500">Accident Count</label>
                  <p className="text-2xl font-bold text-red-600">
                    {driver.accident_count || 0}
                  </p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Moving Violations</label>
                  <p className="text-2xl font-bold text-orange-600">
                    {driver.violation_count || 0}
                  </p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Last Violation</label>
                  <p className="text-sm">
                    {driver.last_violation_date 
                      ? new Date(driver.last_violation_date).toLocaleDateString() 
                      : 'None on record'
                    }
                  </p>
                </div>
