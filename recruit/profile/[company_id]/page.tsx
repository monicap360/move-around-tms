    ...
    <div className="p-8 bg-black text-white min-h-screen">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p>
            Email:{" "}
            <a href={`mailto:${company?.contact_email}`} className="underline">
          ...
          <div className="space-y-4">
            {jobs?.map((job) => (
              <Link
                ...
                className="block p-4 bg-gray-900 rounded-xl border border-gray-700 hover:bg-gray-800"
              >
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  {job.endorsements_required?.map((e) => (
                    <span
                      key={e}
                      className="px-2 py-1 bg-blue-900 rounded text-xs"
                    >
                      {e}
                    </span>
                  ))}
                  ...
                  {job.medical_card_required && (
                    <span className="px-2 py-1 bg-green-700 rounded text-xs">
                      Medical
                    </span>
                  )}
                </div>
