...
export const COMPLIANCE_RULES = {
  federal: {
    dvir: {
      ...
      requiredFields: [
        "company", "date", "truckNumber", "odometer", "driverName", "driverSignature"
      ],
      defectCategories: [
        "brakes", "lights", "steering", "tires", "suspension", "fuel_system", "exhaust_system", "frame_body"
      ]
    },
    maintenance: {
  ...
  states: {
    CA: {
      dvir: {
        ...
        requiredFields: ["company", "date", "truckNumber", "odometer", "driverName", "driverSignature", "trailerNumber"],
        defectCategories: ["brakes", "lights", "steering", "tires", "suspension", "fuel_system", "exhaust_system", "frame_body", "reflectors"]
      },
      maintenance: {
    ...
    NY: {
      dvir: {
        inspectionIntervalDays: 1,
        requiredFields: ["company", "date", "truckNumber", "odometer", "driverName", "driverSignature"],
        defectCategories: ["brakes", "lights", "steering", "tires", "suspension"]
      },
      maintenance: {
...
export function validateDVIR(dvir, state) {
  ...
  const invalidDefects = (dvir.inspection ? Object.keys(dvir.inspection) : []).filter(
