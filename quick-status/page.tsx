...
export default function QuickStatusPage() {
  ...
  const checkStatus = async () => {
    ...
    statusResults.push({
      ...
      status: "info",
      message:
        "Run these commands in Supabase SQL Editor to resolve ownership issue",
    ...
    statusResults.push({
      ...
      status: "warning",
      message:
        "The role executing the commands lacks sufficient privileges to transfer table ownership",
    ...
    statusResults.push({
      ...
      status: "success",
      message:
        "Create index directly as supabase_admin (skip ownership transfer)",
      ...
      {results.length > 0 && (
        <>
                ...
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      {result.action &&
                        result.action !== "copy-commands" &&
                        result.action !== "switch-role" &&
                        result.action !== "direct-create" && (
          ...
          <Alert className="mb-6 border-blue-200 bg-blue-50">
            <AlertDescription>
              <strong>Monica:</strong> The ownership transfer is failing because
              your current role lacks table ownership privileges. Try Solution A
              first (switch to supabase_admin), then Solution B if needed.
            </AlertDescription>
          </Alert>
          ...
          <div className="space-y-6">
            <Card className="border-green-200">
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-3">
                  Switch to supabase_admin role first, then create the index
                  directly. This bypasses the ownership transfer issue.
                </p>
            ...
            <Card className="border-blue-200">
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-3">
                  Create index using CONCURRENT method, which sometimes works
            ...
            <Card className="border-yellow-200">
              ...
              <CardContent>
                <p className="text-sm text-gray-600 mb-3">
                  The original ownership transfer approach - only use if you
                  confirmed you have supabase_admin access.
                </p>
                <div className="bg-gray-900 text-gray-100 p-4 rounded-lg relative">
                  <pre className="text-sm overflow-x-auto whitespace-pre-wrap">
                    {ownershipCommands}
          ...
          <Card className="mt-6 border-purple-200 bg-purple-50">
            <CardHeader>
              <CardTitle className="text-purple-800">
                After Success - Verification Steps
              </CardTitle>
            </CardHeader>
