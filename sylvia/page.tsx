  ...
  return (
    <div className="p-6">
      ...
      <nav className="mb-6 flex gap-4">
        <Link href="/hr" className="text-blue-600 underline">
          HR Dashboard
        </Link>
        <Link href="/payroll" className="text-blue-600 underline">
          Payroll
        </Link>
        <Link href="/drivers" className="text-blue-600 underline">
          Drivers
        </Link>
        <Link href="/marketing" className="text-blue-600 underline">
          Marketing
        </Link>
      </nav>
      {/* Combined Overview */}
      <section className="mb-8">
        ...
        <div className="flex gap-4 mb-4">
          <Link href="/hr" className="bg-blue-500 text-white px-4 py-2 rounded">
            Go to HR
          </Link>
          <Link
            href="/payroll"
      ...
      <section>
        ...
        <div className="bg-white rounded shadow p-4">
          <p>
            Onboarding workflow and status for new drivers will appear here.
          </p>
        </div>
      </section>
    </div>
