        ...
        <AnimatePresence mode="wait">
          {step === 0 && (
            <motion.div
              ...
              className="p-6 bg-gray-900 rounded-2xl mb-4"
            >
              <label className="block mb-2">Weight In (lbs)</label>
              <input
                type="number"
                className="w-full p-3 rounded bg-black border border-cyan-600"
                value={form.weight_in}
                onChange={(e) =>
                  setForm((f) => ({ ...f, weight_in: e.target.value }))
                }
              />
              ...
              <input
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, weight_out: e.target.value }))
                }
              />
          ...
          {step === 2 && (
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, ticket_number: e.target.value }))
                }
              />
              <div className="flex justify-between mt-6">
                <button
          ...
          {step === 4 && (
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  setForm((f) => ({ ...f, material_id: e.target.value }))
                }
              />
              <div className="flex justify-between mt-6">
                <button
          ...
          {step === 5 && (
            ...
            >
              ...
              {success && (
                <div className="text-green-400 mt-4">Ticket submitted!</div>
              )}
            </motion.div>
          )}
        </AnimatePresence>
