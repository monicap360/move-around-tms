...
const navigationSections = [
  {
    ...
    items: [
      ...
      { name: "Driver Schedule", path: "/driver-schedule", icon: ClipboardList },
      { name: "Driver Availability", path: "/driver-availability", icon: Users },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Aggregate Tickets", path: "/aggregates/tickets", icon: FileText },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "DVIR Reference", path: "/driver/dvir-reference", icon: BookOpen },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "DOT Compliance", path: "/compliance/dot-dashboard", icon: ShieldCheck },
    ]
  },
  {
    name: "System",
