...
export default function UploadProgress({
  ...
  return (
    <div
      className={`rounded-lg border p-4 transition-all duration-300 ${getStatusColor()}`}
    >
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center justify-between mb-2">
            <p className="font-medium text-sm truncate">{getStatusMessage()}</p>
      ...
      <div className="bg-white rounded-lg border p-4 shadow-sm">
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between text-sm text-gray-600">
            ...
            <span>
              {completedCount} completed, {failedCount} failed, {activeCount}{" "}
              uploading
            </span>
          </div>
        </div>
      ...
      <div className="space-y-2">
        {uploads.map((upload) => (
          <UploadProgress
            ...
            onCancel={
              onCancelSingle ? () => onCancelSingle(upload.id) : undefined
            }
            showDetails={false}
          />
        ))}
