...
export default function VeronicaLayout({
  children,
}: {
    ...
    <div className="veronica-dashboard">
      <header className="header">
        ...
        <nav className="header-nav">
          <a href="/partners/ronyx" className="nav-link">
            ← ROnyx Portal
          </a>
          <a href="/veronica" className="nav-link">
            Owner-Operators
          </a>
          <a href="/veronica/change-password" className="nav-link">
            🔐 Change Password
          </a>
        </nav>
      </header>
